<?php 
  ...
  if (isset($_POST['updatestudent'])) {
  	...
  	if (mysqli_query($db_con,$query)) {
  		$datainsert['insertsucess'] = '<p style="color: green;">Student Enroll!</p>';
		
  		header('Location: index.php?page=all-applicant&edit=success');
  	}else{
  		header('Location: index.php?page=all-applicant&edit=error');
  	}
  }
?>
<h1 class="text-primary"><i class="fas fa-user-plus"></i>  Applicant Detail!</h1>
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
     <li class="breadcrumb-item" aria-current="page"><a href="index.php">Dashboard </a></li>
     <li class="breadcrumb-item" aria-current="page"><a href="index.php?page=all-student">All Applicant </a></li>
     <li class="breadcrumb-item active" aria-current="page">Applicant Detail</li>
  </ol>
</nav>
	...
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group text-center">
		    <input name="updatestudent" value="Accept Application" type="submit" class="btn btn-success">
	  	</div>
	 </form>
</div>
</div>