...
?>
<h1 class="text-primary"><i class="fas fa-user-plus"></i>  Edit Children Informations!<small class="text-warning"> </small></h1>
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
     <li class="breadcrumb-item" aria-current="page"><a href="index.php">Dashboard </a></li>
     <li class="breadcrumb-item" aria-current="page"><a href="index.php?page=all-student">All Children </a></li>
     <li class="breadcrumb-item active" aria-current="page">Children Detail</li>
  </ol>
</nav>
